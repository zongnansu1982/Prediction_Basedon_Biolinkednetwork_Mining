 ...
 *
 */
public class LocalGraphVectorSerializer {
    private static final Logger log = LoggerFactory.getLogger(LocalGraphVectorSerializer.class);
    private static final String DELIM = "\t";

    public static void writeGraphVectors(Deepwalk_enhenced deepWalk, String path) throws IOException {
    ...
    public static GraphVectors loadTxtVectors(File file, String delim) throws IOException {
